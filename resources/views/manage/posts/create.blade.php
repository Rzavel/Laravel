...
<div class="field">
  <div class="control">
    <input class="input is-large" type="text" placeholder="Post Title" v-model="title">
  </div>
</div>
...
<div class="field m-t-10">
  <div class="control">
    <textarea class="textarea is-primary" type="text" placeholder="Compose your master Piece" rows="20"></textarea>
  </div>
</div>
